...
{
	// Extensions are "representatives" of child nodes.  Partial solutions are normally somewhat expensive to 
	...
	// partial solution identical to the old one but with the specified ship placed in the specified spot.
	//
	// IExtension supports IComparable so that we can potentially heuristically sort the child nodes in order
	...
	// a minimum.
	//
	// NOTE: IExtensions are used in a few places - backtracker, reasons and generators for instance.  There
